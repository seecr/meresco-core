...
from plugins.fieldcountplugin import FieldCountPlugin, registerOn, XML_CONTENT_TYPE, PluginException, ERROR_MESSAGE
...
class FieldCountPluginTest(CQ2TestCase):
	...
	def testRegistry(self):
		...
		self.assertEquals("registerByCommand('fieldcount', <class plugins.fieldcountplugin.FieldCountPlugin>)", str(registry.calledMethods[0]))

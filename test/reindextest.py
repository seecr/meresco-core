...
class ReindexTest(CQ2TestCase):
    def testEnumerateStorage(self):
        ...
        self.assertEquals("add('identifier:B', 'ignoredName', <etree._ElementTree>)", str(observer.calledMethods[0]))
        self.assertEquals("add('identifier:C', 'ignoredName', <etree._ElementTree>)", str(observer.calledMethods[1]))
        self.assertEquals("add('identifier:A', 'ignoredName', <etree._ElementTree>)", str(observer.calledMethods[2]))

...
from meresco.legacy.plugins.resetplugin import ResetPlugin, registerOn
...
class ResetPluginTest(CQ2TestCase):
    ...
    def testRegistry(self):
        ...
        self.assertEquals("registerByCommand('reset', <class meresco.legacy.plugins.resetplugin.ResetPlugin>)", str(registry.calledMethods[0]))

...
import unittest
from queryserver.plugins.sruplugin import SUCCESS, SRUPlugin, SRUDiagnostic, MANDATORY_PARAMETER_NOT_SUPPLIED, UNSUPPORTED_PARAMETER, UNSUPPORTED_VERSION, UNSUPPORTED_OPERATION, UNSUPPORTED_PARAMETER_VALUE, QUERY_FEATURE_UNSUPPORTED, registerOn
...
class SRUPluginTest(CQ2TestCase):
	...
	def testRegistry(self):
		...
		self.assertEquals("registerByCommand('sru', <class queryserver.plugins.sruplugin.SRUPlugin>)", str(registry.calledMethods[0]))
